...
class BridgeModule(nn.Module):
    """
    Chuyển latent [256, 40, 40] thành [256, 160, 160] bằng upsampling + conv.
    """
    def __init__(self):
        super(BridgeModule, self).__init__()
        self.upsample1 = nn.Upsample(scale_factor=2, mode='nearest')  # [256, 80, 80]
        self.conv1 = nn.Conv2d(256, 256, kernel_size=3, padding=1)
        self.upsample2 = nn.Upsample(scale_factor=2, mode='nearest')  # [256, 160, 160]
